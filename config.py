# 소상공인 지원사업 매칭 프로그램 설정 파일

# 지역 데이터 (17개 시/도 및 하위 시/군/구)
# API 응답에서 지역 매칭 시 사용
REGIONS = {
    ...
    "강원특별자치도": ["강릉시", "고성군", "동해시", "삼척시", "속초시", "양구군", "양양군", "영월군",
...
# 연령대 데이터 (키워드 매칭용)
# 값(리스트)은 API 응답에서 연령 조건 매칭 시 사용할 키워드들
AGE_GROUPS = {
    "청년 (만 19~34세)": ["청년", "만 19세", "만 34세", "39세 이하", "청년층", "20대", "30대"],
    "중장년 (만 35~59세)": ["중장년", "중년", "40대", "50대", "장년"],
    "시니어 (만 60세 이상)": ["시니어", "노인", "어르신", "60세", "고령", "60대", "70대"]
}

# 기업마당 API 분류 기준 8개 분야
# 지원사업 분야 필터링에 사용
SUPPORT_CATEGORIES = [
    "금융",
    "기술",
